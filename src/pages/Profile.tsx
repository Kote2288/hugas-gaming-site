    ...
    return (
      <div className="min-h-screen bg-dark-bg pt-20 flex items-center justify-center">
        <div className="text-center max-w-md px-4">
          ...
          <h2 className="font-oswald text-3xl text-white mb-3">
            ДОСТУП ЗАКРЫТ
          </h2>
          <p className="text-gray-500 text-sm mb-8">
            Войдите через Steam для просмотра профиля
          </p>
          <button
            onClick={steamLogin}
            className="btn-neon-filled px-8 py-4 flex items-center gap-3 mx-auto"
          >
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {paymentSuccess && (
          <div className="mb-6 border border-green-500/40 bg-green-900/20 p-4 flex items-center gap-3">
            ...
            />
            <div>
              <div className="font-oswald text-green-400">
                ОПЛАТА ПРОШЛА УСПЕШНО!
              </div>
              <div className="font-mono-tech text-xs text-green-600">
                Баланс пополнен. Средства зачислены на ваш счёт.
              </div>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="card-dark p-6 text-center">
              ...
              <h2 className="font-oswald text-2xl text-white mb-1">
                {user.name}
              </h2>
              <div
                className={`inline-block font-mono-tech text-xs border px-3 py-1 mb-4 ${badge.color}`}
              >
                {badge.label}
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-dark-bg p-3">
                  <div className="font-mono-tech text-xs text-gray-600 mb-1">
                    БАЛАНС
                  </div>
                  <div className="font-oswald text-xl text-neon">
                    {user.balance}₽
                  </div>
                </div>
                <div className="bg-dark-bg p-3">
              ...
              <button
                ...
                className="w-full btn-neon-filled py-3 flex items-center justify-center gap-2"
              >
          ...
          <div className="lg:col-span-2">
            <div className="card-dark p-6 mb-4">
              <div className="flex items-center justify-between mb-4">
                <div className="font-mono-tech text-xs text-neon/60 tracking-widest">
                  // ИСТОРИЯ ПОКУПОК
                </div>
                <span className="font-mono-tech text-xs text-gray-600">
                  {user.purchases?.length || 0} покупок
                </span>
              </div>
              ...
              {!user.purchases?.length ? (
                ...
                <div className="space-y-3">
                  {user.purchases.map((p, idx) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between p-3 border border-neon/10 hover:border-neon/20 transition-all"
                    >
                      <div>
            ...
            <div className="card-dark p-6">
              <div className="font-mono-tech text-xs text-neon/60 tracking-widest mb-4">
                // КАК ПОЛУЧИТЬ КУПЛЕННЫЕ ТОВАРЫ
              </div>
              <div className="space-y-3">
                {[
                  { icon: "LogIn", step: "1. Зайди на сервер Odium Dayz" },
                  {
                    icon: "MessageSquare",
                    step: "2. В чате введи команду /shop",
                  },
                  {
                    icon: "Package",
                    step: '3. Выбери купленный предмет и нажми "Получить"',
                  },
                  {
                    icon: "CheckCircle",
                    step: "4. Предмет появится в твоём инвентаре",
                  },
                ].map((item) => (
                  <div
                    key={item.step}
                  ...
                  >
                    <Icon
                      name={item.icon}
                      size={16}
                      className="text-neon/60 shrink-0"
                    />
                    {item.step}
                  </div>
                ))}
      ...
      {showTopUp && (
        ...
        >
          ...
          >
            ...
            />
            {paymentError && (
              <div className="text-red-400 font-mono-tech text-xs mb-4">
                {paymentError}
              </div>
            )}
            <div className="text-xs text-gray-600 font-mono-tech mb-4">
              Оплата через ЮКасса (банковская карта, SBP, ЮMoney). Безопасно и
              мгновенно.
            </div>
            <button
              onClick={handleTopUp}
            ...
            <div className="flex items-center justify-center gap-2 mt-4">
              <span className="text-gray-700 text-xs font-mono-tech">
                Безопасная оплата:
              </span>
